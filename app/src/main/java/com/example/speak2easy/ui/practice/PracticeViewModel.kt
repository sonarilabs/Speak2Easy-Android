...
import com.example.speak2easy.service.AudioRecorder
import com.example.speak2easy.service.HapticsManager
import com.example.speak2easy.service.TtsPlayer
...
class PracticeViewModel(
    ...
    private fun scheduleAutoRecord() {
        viewModelScope.launch {
            ...
            if (state.phase == PracticePhase.ACTIVE && !state.isRecording && !state.isSubmitting && !state.showResult) {
                startRecording()
            }
        }
    }
