...
import com.example.speak2easy.ui.auth.GoogleAuthHelper
        ...
        if (webClientId.isBlank()) {
            ...
            scope.launch {
                try {
                    ...
                    viewModel.onGoogleCredential(cred.providerUserId, cred.email, cred.displayName)
...
private fun OnboardingStepsFlow(container: AppContainer) {
    val viewModel: OnboardingViewModel = viewModel(factory = OnboardingViewModel.Factory(container.authRepository))
