package com.example.speak2easy.data.lessons
 ...
 * in [com.example.speak2easy.data.practice.ProgressRepository] with a short TTL.
 *
 ...
 * fallback via [com.example.speak2easy.ui.lessons.LessonData]).
 */
